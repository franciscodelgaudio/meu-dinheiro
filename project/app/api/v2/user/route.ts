...
import { CreateUserRequestV2, toCreateUserInput } from "@/lib/contracts/v2/user";
import { getRateLimiter, getClientIp } from "@/lib/rateLimit";
import { STATUS_CODES } from "@/lib/statusCode";

// Mesma chave da v1: é o mesmo recurso sendo protegido, independente da
// versão usada pra chamar — senão dava pra contornar o limite trocando de versão.
const RATE_LIMIT = 5;
...
export async function POST(request: NextRequest) {
    ...
    const parsedBody = CreateUserRequestV2.safeParse(body);
