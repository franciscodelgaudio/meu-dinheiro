...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        "z-50 min-w-56 origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-lg outline-none data-[side=bottom]:animate-in data-[side=bottom]:slide-in-from-top-2 data-[side=left]:animate-in data-[side=left]:slide-in-from-right-2 data-[side=right]:animate-in data-[side=right]:slide-in-from-left-2 data-[side=top]:animate-in data-[side=top]:slide-in-from-bottom-2",
        className,
      )}
      {...props}
    />
